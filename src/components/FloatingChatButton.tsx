...
const FloatingChatButton = () => {
  ...
  return (
    <button
      onClick={handleClick}
      className="fixed bottom-6 left-6 z-50 flex items-center gap-3 bg-background rounded-full px-4 py-2 shadow-strong hover:shadow-glow transition-all duration-300 hover:scale-105 border border-border/50"
    >
      <img
